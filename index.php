...
if (!isset($_SESSION['username'])) {
    // Tampilkan notifikasi jika belum login
    echo "
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    title: 'Selamat Datang di AyoBelajar.id!',
                    text: 'Silakan login untuk menikmati fitur belajar yang interaktif dan menyenangkan.',
                    icon: 'info',
                    ...
                    if (result.isConfirmed) {
                        window.location.href = 'login.php'; // Redirect ke halaman login
                            ...
                            // Menonaktifkan semua elemen kecuali tombol login
...
// Notifikasi selamat datang jika baru login
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    text: 'Selamat menjelajahi dunia belajar bersama kami.',
                    icon: 'success',
...
<!-- Navbar -->
<nav class="flex justify-between items-center bg-blue-600 text-white p-4 fixed w-full">
    <div class="flex items-center">
        <img src="img/logo.png" alt="AyoBelajar Logo" class="h-10 mr-3 rounded-full">
    ...
    <?php endif; ?>
        ...
        <div class="relative">
            ...
            <div id="dropdown2" class="hidden absolute mt-2 w-44 bg-white rounded-lg shadow-lg">
                <ul class="py-2 text-sm text-gray-800">
                    <li><a href="https://gurudikdas.kemdikbud.go.id/storage/users/3/Berita/file%20pdf/BUKU%20MODUL%20PEMBELAJARAN/FINAL%20Modul%201_Gemar%20Membaca%20Terampil%20Menulis.pdf" target="blank" class="block px-4 py-2 hover:bg-gray-100">Materi</a></li>
                    <li><a href="https://www.youtube.com/watch?v=JiAavHAksgw" target="blank" class="block px-4 py-2 hover:bg-gray-100">Video</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="relative">
            ...
            <div id="dropdown3" class="hidden absolute mt-2 w-44 bg-white rounded-lg shadow-lg">
                <ul class="py-2 text-sm text-gray-800">
                    <li><a href="https://paudpedia.kemdikbud.go.id/uploads/anggun/images/2020/12_buku_BDR/Bermain_Matematika_yang_menyenangkan_dengan_anak_dirumah.pdf" target="blank" class="block px-4 py-2 hover:bg-gray-100">Materi</a></li>
                    <li><a href="https://www.youtube.com/watch?app=desktop&v=NAT89oYinxE&t=0s" target="blank" class="block px-4 py-2 hover:bg-gray-100">Video</a></li>
                </ul>
            </div>
        </div>
    ...
    <?php if (!isset($_SESSION['username'])): ?>
        <button class="bg-purple-700 text-white px-4 py-2 rounded-lg hover:bg-yellow-800 focus:outline-none">
    ...
    <div class="flex">
        ...
        <aside class="bg-blue-400 flex flex-col p-5 w-1/6"> <!-- Sidebar biru -->
            ...
            <a href="https://paudpedia.kemdikbud.go.id/uploads/anggun/images/2020/12_buku_BDR/Bermain_Sains-2.pdf" target="blank" class="text-gray-700 hover:text-white hover:bg-yellow-400 rounded px-3 py-2 mt-2">
                Belajar Sains Dasar
            </a>
        ...
        <aside class="bg-blue-400 flex flex-col p-5 w-1/6">
            ...
            <a href="https://www.youtube.com/@ayobelajartv5117" target="_blank" class="text-gray-700 hover:text-white hover:bg-yellow-400 rounded px-3 py-2">Youtube AyoBelajar</a>
